  ...
  return (
    <div className="flex gap-8 max-lg:flex-col-reverse justify-center mt-8 ">
      <div className="max-lg:flex-row gap-8 max-sm:flex-col  flex flex-col">
        <div className="flex-1 max-w-lg rounded-[30px] p-10 flex dark:bg-secondary flex-col justify-start items-start bg-primary">
          <p>Capital raised</p>
        ...
        <div className="flex-1 max-w-lg rounded-[30px] dark:bg-secondary p-10 flex flex-col justify-start items-start bg-primary">
      ...
      <div className="flex flex-col bg-primary dark:bg-secondary rounded-[30px] gap-6">
        <h1 className="text-start text-7xl mx-8 mt-8 font-bold max-sm:text-5xl">
