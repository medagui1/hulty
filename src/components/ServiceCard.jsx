...
const ServiceCard = ({order, service, content}) => {
  return (
    <div className={`flex flex-col flex-1 p-8 rounded-2xl w-[330px] min-w-[260px] ${order === '01' ? `bg-secondary text-white dark:bg-white dark:text-primary` : `bg-white dark:bg-tertiary text-white`}`}>
